...
|-------|----------|--------|
| **Agents** | 15 autonomous agents + orchestrator: SSOT Auditor, Security Scanner, Code Reviewer, UI Designer, Contract Tester, Integration Tester, Regression Watcher, AI Verifier... | Beta |
