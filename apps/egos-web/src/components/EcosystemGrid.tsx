...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    statusLabel: 'Beta',
    completion: 60,
    description: '14 agentes autônomos com orchestrador: SSOT Auditor, Auth Checker, Code Reviewer, UI Designer, Contract Tester, Integration Tester, AI Verifier e mais.',
    details: '14 agentes registrados + orchestrador (100% health). 5-layer testing: static analysis → contract → integration → regression → AI verification. AI Verifier testa o chatbot com ataques adversariais e avalia respostas. 4 case studies reais. Zero-dependency.',
