...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    statusLabel: 'Beta',
    completion: 60,
    description: '13 agentes autônomos com orchestrador: SSOT Auditor, Auth Checker, Code Reviewer, Dep Auditor, Dead Code, UI Designer, Contract Tester, Integration Tester.',
    details: '13 agentes registrados + orchestrador (100% health). Runtime próprio, CLI, logs JSONL, dry-run/execute. 5-layer testing architecture: static analysis → contract tests → integration tests → regression → AI verification. 4 case studies reais. Zero-dependency.',
