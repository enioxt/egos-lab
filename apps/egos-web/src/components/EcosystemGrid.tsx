...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    statusLabel: 'Beta',
    completion: 60,
    description: '11 agentes autônomos com orchestrador: SSOT Auditor, Auth Checker, Code Reviewer, Dep Auditor, Dead Code, UI Designer.',
    details: '11 agentes registrados + orchestrador (100% health, 6.1s). Runtime próprio, CLI, logs JSONL, dry-run/execute. 4 case studies reais: Documenso (1012), Cal.com (1469), tRPC (388), Medusa (2427 findings). Zero-dependency.',
