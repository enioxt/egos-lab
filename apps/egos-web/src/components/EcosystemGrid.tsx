...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    statusLabel: 'Beta',
    completion: 60,
    description: '15 agentes autônomos com orchestrador: System Prompt Auditor, Auth Checker, Code Reviewer, UI Designer, Contract Tester, Integration Tester, Regression Watcher, AI Verifier e mais.',
