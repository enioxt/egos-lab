...
const ALL_ITEMS: ProjectItem[] = [
  ...
  // ═══ Agentic Platform ═══
  {
    ...
    description: '14 agentes autônomos + orchestrador — auditam, testam e evoluem codebases com 5 camadas de verificação.',
    details: 'SSOT Auditor, Security Scanner, Auth Checker, Cortex Reviewer, Dep Auditor, Dead Code Detector, Idea Scanner, Rho Calculator, Knowledge Disseminator, UI Designer, Contract Tester, Integration Tester, AI Verifier, E2E Smoke. Orchestrador roda todos e gera relatório combinado. 4 case studies: Documenso (1012), Cal.com (1469), tRPC (388), Medusa (2427 findings). Zero dependências externas, roda em qualquer projeto TS.',
    icon: Bot,
    status: 'live',
    category: 'agent',
    techStack: ['Bun', 'TypeScript', 'JSONL', 'OpenRouter'],
    metrics: '14 agentes, 5-layer testing, 4 case studies, 100% health',
    githubPath: 'agents',
