...
const ALL_ITEMS: ProjectItem[] = [
  ...
  // ═══ Agentic Platform ═══
  {
    ...
    description: '10 agentes autônomos + orchestrador — auditam, protegem e evoluem codebases em <4s.',
    details: 'SSOT Auditor, Security Scanner, Auth Checker, Cortex Reviewer, Dep Auditor, Dead Code Detector, Idea Scanner, Rho Calculator, Knowledge Disseminator, E2E Smoke. Orchestrador roda todos e gera relatório combinado. 4 case studies: Documenso (1012), Cal.com (1469), tRPC (388), Medusa (2427 findings). Zero dependências externas, roda em qualquer projeto TS.',
    icon: Bot,
    status: 'live',
    category: 'agent',
    techStack: ['Bun', 'TypeScript', 'JSONL', 'OpenRouter'],
    metrics: '10 agentes, 4 case studies, 100% health, 3.8s total',
    githubPath: 'agents',
